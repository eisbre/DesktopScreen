...
void ds_system_data_init(){
    ...
    g_system_data.year = 123;
    g_system_data.mon = 9;
    g_system_data.day = 1;
    g_system_data.week = 0;
}
...
void update_system_time(uint8_t hour,uint8_t minute,uint8_t second,uint8_t year,uint8_t mon,uint8_t day,uint8_t week){
    ESP_LOGI(TAG,"update system time %d:%d:%d\n",hour,minute,second);
    g_system_data.hour = hour;
    g_system_data.minute = minute;
    g_system_data.second = second;
    g_system_data.year = year;
    g_system_data.mon = mon;
    g_system_data.day = day;
    g_system_data.week = week;
}
