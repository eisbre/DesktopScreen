...
#include "../../Inc/ui/ds_ui_timepage.h"
#include "../../Inc/ui/ds_ui_wordpage.h"
#include "../../Inc/screen/d_screen.h"
#include "../../Inc/ui/ds_ui_weatherpage.h"
#include "../../Inc/ui/ds_ui_tomatopage.h"
//#include "ds_http_request.h"
#include "../../Inc/ui/ds_ui_fans.h"
//#include "ds_pwm.h"
...
static void ui_page_evt_task(void *arg)
{
    while (1) {
		...
		else if(evt.action == PAGE_TYPE_DESKTOP){
			g_page_manage.now_show_page = PAGE_TYPE_DESKTOP;
			ds_screen_desktop();
		}
		//TP点击事件
		if(g_page_manage.now_show_page == PAGE_TYPE_MEMU){
			...
			else if(g_page_manage.now_show_page == PAGE_TYPE_DESKTOP){
				if(evt.key == TP_ACTION_MOVE_LEFT){
					g_page_manage.now_show_page = PAGE_TYPE_MEMU;
					ds_screen_display_main();
				}
